...
@Component({
  moduleId: module.id,
  selector: 'website-statistic-chart',
  templateUrl: './line-chart-template/line-chart-template.html',
  styleUrls: ['./line-chart-template/line-chart-style.css']
})

export class WebsiteStatisticChart implements OnInit {
  ChartTitle: string = 'Site Statistics';
  ChartValue: number = 12.147;
  date: Date;
  hours: any;
  minutes: any;
  seconds: any;
