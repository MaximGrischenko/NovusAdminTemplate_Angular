...
@Component({
  moduleId: module.id,
  selector: 'orders-statistic-chart',
  templateUrl: './line-chart-template/line-chart-template.html',
  styleUrls: ['./line-chart-template/line-chart-style.css']
})

export class OrdersStatisticChart implements OnInit {
  ChartTitle: string = 'Today\'s Order\'s';
  ChartValue: number = 319;
  date: Date;
  hours: any;
  minutes: any;
  seconds: any;
