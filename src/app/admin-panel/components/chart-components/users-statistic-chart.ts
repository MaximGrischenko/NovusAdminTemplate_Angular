...
@Component({
  moduleId: module.id,
  selector: 'users-statistic-chart',
  templateUrl: './line-chart-template/line-chart-template.html',
  styleUrls: ['./line-chart-template/line-chart-style.css']
})

export class UsersStatisticChart implements OnInit {
  ChartTitle: string = 'Today\'s User\'s';
  ChartValue: number = 2843;
  date: Date;
  hours: any;
  minutes: any;
  seconds: any;
